...
if(isset($_POST['ok'])){
  ...
  $q="UPDATE `task` SET `id`='$id',`user_name`='$user_name',`author`='autor',`image`='$file',`eventdt`='$event_dt' WHERE id=$id;";
    ...
    <div class="container">
      <div class="col-lg-6 m-auto">
      	<h1>Update Operation</h1>
            <form method="post" enctype="multipart_page_binary">
              <div class="row mb-3">
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="file" name="image" class="form-control" id="inputfile3" value="<?php echo $user_name; ?>">
                </div>
              </div>
              <div class="row mb-3">
